...
public class ViewpName extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.viewpname);
        ...
        handler.post(new Runnable() {
            ...
            public void run() {
                ...
                data[0] = name;
                putData = new PutData("http://52.203.34.134/disaster/Getpdata.php", "POST", field, data);
                if (putData.startPut()) {
